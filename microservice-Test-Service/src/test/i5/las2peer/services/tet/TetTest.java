package i5.las2peer.services.tet;
 ...
 * 
 * This class provides a basic testing framework for the microservice Test-Service. It was
...
public class TetTest {
  ...
  private static final ServiceNameVersion testTemplateService = new ServiceNameVersion(Tet.class.getCanonicalName(),"0.1");

  private static final String mainPath = "http://localhost";

...
@Api
@SwaggerDefinition(
    info = @Info(title = "Test-Service", version = "0.2",
...
public class Tet extends Service {
  ...
  public HttpResponse test() {
    ...
    if(test_condition) {
      ...
      HttpResponse test = new HttpResponse(test.toJSONString(), HttpURLConnection.HTTP_OK);
      return test;
    }
    return null;
  }
